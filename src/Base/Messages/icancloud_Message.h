...
/** MPI Null operation */
static const unsigned int MPI_NULL = 100;
...
/**
 * @class icancloud_Message icancloud_Message.h "icancloud_Message.h"
 *
...
class icancloud_Message: public icancloud_Message_Base{
	...
	public:
		...
		*/
		icancloud_Message (const char *name=NULL, int kind=0);
		...
		*/
		virtual icancloud_Message *dup() const;
		...
		*/
    	...
    	string getChangingState ();


    	void add_component_index_To_change_state (int componentIndex);


    	int get_component_to_change_size ();


    	int get_component_to_change (int componentsPosition);
