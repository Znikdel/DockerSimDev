...
void AppBase::finish(){
    ...
    printf("AppBase finished.");
   UserJob::finish();

}

void AppBase::startExecution (){
...
void AppBase::processSelfMessage (cMessage *msg){
...
void AppBase::processRequestMessage (icancloud_Message *sm){

}


void AppBase::processResponseMessage (icancloud_Message *sm){
...
void AppBase::changeState(string newState){

}


void AppBase::executeIOrequest(bool executeRead, bool executeWrite){
...
void AppBase::executeCPUrequest(){
