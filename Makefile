...
INCLUDE_PATH = \
    ...
    -Isimulations/DockerTest \
    -Isimulations/DockerTest/results \
    -Isimulations/SmallForTest \
    -Isimulations/SmallForTest/results \
    -Isimulations/Test2Apps \
    -Isimulations/Test2Apps/results \
    -Isrc \
    -Isrc/Applications \
...
LIBS = -L../inet/out/$(CONFIGNAME)/src -L$(QUEUEINGLIB_PROJ)/out/$(CONFIGNAME) -L$(QUEUEINGLIBEXT_PROJ)/out/$(CONFIGNAME)  -lz -linet -lqueueinglib -lqueueinglibext
LIBS += -Wl,-rpath,`abspath ../inet/out/$(CONFIGNAME)/src` -Wl,-rpath,`abspath $(QUEUEINGLIB_PROJ)/out/$(CONFIGNAME)` -Wl,-rpath,`abspath $(QUEUEINGLIBEXT_PROJ)/out/$(CONFIGNAME)`
...
OBJS = \
    $O/src/Applications/Apps/AppBase.o \
    ...
    $O/src/Applications/Base/ContainerSink.o \
...
INET_PROJ=../inet
QUEUEINGLIB_PROJ=/home/nikdel/omnetpp-4.6/samples/queueinglib
QUEUEINGLIBEXT_PROJ=/home/nikdel/omnetpp-4.6/samples/queueinglibext
...
clean:
	...
	$(Q)-rm -f simulations/DockerTest/*_m.cc simulations/DockerTest/*_m.h
	$(Q)-rm -f simulations/DockerTest/results/*_m.cc simulations/DockerTest/results/*_m.h
	$(Q)-rm -f simulations/SmallForTest/*_m.cc simulations/SmallForTest/*_m.h
	$(Q)-rm -f simulations/SmallForTest/results/*_m.cc simulations/SmallForTest/results/*_m.h
	$(Q)-rm -f simulations/Test2Apps/*_m.cc simulations/Test2Apps/*_m.h
	$(Q)-rm -f simulations/Test2Apps/results/*_m.cc simulations/Test2Apps/results/*_m.h
...
$O/src/Applications/Apps/ServerApplication/ServerApplication.o: src/Applications/Apps/ServerApplication/ServerApplication.cc \
	...
	$(INET_PROJ)/src/transport/contract/TCPCommand_m.h \
	$(INET_PROJ)/src/transport/contract/TCPSocket.h
$O/src/Applications/Base/ContainerSink.o: src/Applications/Base/ContainerSink.cc \
	src/Applications/Base/ContainerSink.h \
	$(INET_PROJ)/src/base/Compat.h \
	$(INET_PROJ)/src/base/INETDefs.h \
	$(INET_PROJ)/src/base/Sink.h \
